        ...
        <form action="{{ route('jadwal-pelajaran.store') }}" method="POST" id="jadwalForm">
            ...
            <div class="p-6">
                ...
                <div>
                    ...
                    <select name="ruangan_id" id="ruangan_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 @error('ruangan_id') border-red-500 @enderror">
