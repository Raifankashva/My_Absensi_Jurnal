    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100">
            <div class="bg-blue-600 px-6 py-4">
                <h3 class="text-xl font-semibold text-white">Filter Export</h3>
            </div>
            <div class="p-6">
                <form action="{{ route('adminguru.export.excel') }}" method="get">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            <label for="year" class="block text-sm font-medium text-gray-700 mb-2">Tahun:</label>
                            <select name="year" id="year" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                @php
                                $currentYear = date('Y');
                        ...
                        <div>
                            ...
                            <select name="month" id="month" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div>
                            ...
                            <select name="sekolah_id" id="sekolah_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                    ...
                    <div class="mt-8 flex flex-wrap gap-4">
                        <button type="submit" class="inline-flex items-center px-5 py-2.5 bg-green-600 text-white font-medium rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            Export Excel
                        </button>
                        <a href="{{ route('adminguru.export.pdf') }}"
                            onclick="event.preventDefault(); document.getElementById('pdf-export-form').submit();"
                            class="inline-flex items-center px-5 py-2.5 bg-red-600 text-white font-medium rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <form id="pdf-export-form" action="{{ route('adminguru.export.pdf') }}" method="get" class="hidden">
                    <input type="hidden" name="year" id="pdf-year">
                    <input type="hidden" name="month" id="pdf-month">
                    @if(auth()->user()->role === 'admin')
                    <input type="hidden" name="sekolah_id" id="pdf-sekolah">
                    @endif
                </form>
            </div>
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const pdfSchool = document.getElementById('pdf-sekolah');

        yearSelect.addEventListener('change', function() {
            pdfYear.value = this.value;
        });

        monthSelect.addEventListener('change', function() {
            pdfMonth.value = this.value;
        });

        if (schoolSelect) {
            schoolSelect.addEventListener('change', function() {
                pdfSchool.value = this.value;
            });
        }
        ...
        if (schoolSelect) {
            pdfSchool.value = schoolSelect.value;
        }
    });
</script>
