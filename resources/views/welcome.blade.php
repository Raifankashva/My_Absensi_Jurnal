...
<div class="min-h-screen relative overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-4 py-12 lg:py-16">
        <div class="text-center mb-12 lg:mb-16 animate-fade-in">
            <div class="flex justify-center mb-8">
                <div class="bg-gradient-to-r from-blue-600 to-blue-600 p-4 rounded-2xl shadow-2xl transform hover:scale-110 transition-all duration-300">
                    <i class="bx bxs-school text-5xl text-white"></i>
                </div>
            </div>
            <h1 class="text-3xl md:text-5xl lg:text-6xl font-bold text-blue-900 mb-4">
        ...
        <div class="bg-white/50 backdrop-blur-lg rounded-2xl p-6 lg:p-8 shadow-lg mb-12">
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                ...
                $stats = [
                    ...
                    ['number' => '1000+', 'label' => 'Jurnal Per Bulan', 'icon' => 'bxs-book-open', 'color' => 'blue'],
        ...
        <div class="text-center">
            <div class="bg-gradient-to-r from-blue-600 to-blue-600 rounded-2xl p-6 lg:p-8 shadow-lg transform hover:scale-105 transition-all duration-300">
                <h2 class="text-2xl lg:text-3xl font-bold text-white mb-4">Mulai Sekarang</h2>
                <p class="text-blue-100 mb-6">Bergabung dengan platform kami untuk pengalaman manajemen pendidikan yang lebih baik</p>
                <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="#panduan" class="bg-blue-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300">
                        Lihat Panduan
                    </a>
                </div>
            </div>
 ...
 <div id="panduan" class="relative z-10 container mx-auto px-4 py-12 mt-8">
        <div class="bg-white/50 backdrop-blur-lg rounded-2xl p-8 shadow-lg">
            <h2 class="text-3xl font-bold text-blue-900 mb-8 text-center">Panduan Penggunaan Sistem</h2>
            ...
            <div x-data="{ activeTab: 'absensi' }" class="mb-8">
                <div class="flex flex-wrap justify-center gap-4 mb-8">
                    <button 
                        ...
                        :class="{ 'bg-blue-600 text-white': activeTab === 'absensi', 'bg-gray-100 text-gray-600 hover:bg-gray-200': activeTab !== 'absensi' }"
                        class="px-6 py-2 rounded-full font-medium transition-all duration-300">
                        Absensi Digital
                    </button>
                    <button 
                        @click="activeTab = 'jurnal'" 
                        :class="{ 'bg-blue-600 text-white': activeTab === 'jurnal', 'bg-gray-100 text-gray-600 hover:bg-gray-200': activeTab !== 'jurnal' }"
                        class="px-6 py-2 rounded-full font-medium transition-all duration-300">
                        Jurnal Mengajar
                    </button>
                    <button 
                        @click="activeTab = 'siswa'" 
                        :class="{ 'bg-blue-600 text-white': activeTab === 'siswa', 'bg-gray-100 text-gray-600 hover:bg-gray-200': activeTab !== 'siswa' }"
                        class="px-6 py-2 rounded-full font-medium transition-all duration-300">
                        Data Siswa
                    </button>
                </div>
                ...
                <div x-show="activeTab === 'absensi'" class="space-y-6">
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-blue-800 mb-4">Cara Mengisi Absensi</h3>
                            <ol class="space-y-4">
                                <li class="flex gap-3">
                                    <div class="bg-blue-100 text-blue-600 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">1</div>
                                    <div>
                                        <p class="text-gray-600">Login ke sistem menggunakan akun Anda</p>
                                    </div>
                                </li>
                                <li class="flex gap-3">
                                    <div class="bg-blue-100 text-blue-600 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">2</div>
                                    <div>
                                        <p class="text-gray-600">Pilih menu "Absensi Digital" pada dashboard</p>
                                    </div>
                                </li>
                                <li class="flex gap-3">
                                    <div class="bg-blue-100 text-blue-600 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">3</div>
                                    <div>
                                        <p class="text-gray-600">Pilih kelas dan tanggal yang sesuai</p>
                                    </div>
                                </li>
                                <li class="flex gap-3">
                                    <div class="bg-blue-100 text-blue-600 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">4</div>
                                    <div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-blue-800 mb-4">Fitur Absensi</h3>
                            <ul class="space-y-4">
                                <li class="flex items-start gap-3">
                                    <i class="bx bx-check-circle text-blue-600 text-xl mt-1"></i>
                ...
                <div x-show="activeTab === 'jurnal'" class="space-y-6">
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-blue-800 mb-4">Pengisian Jurnal Mengajar</h3>
                            <ol class="space-y-4">
                                <li class="flex gap-3">
                                    <div class="bg-blue-100 text-blue-600 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">1</div>
                                    <div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-blue-800 mb-4">Fitur Jurnal</h3>
                            <ul class="space-y-4">
                                <li class="flex items-start gap-3">
                                    <i class="bx bx-check-circle text-blue-600 text-xl mt-1"></i>
                ...
                <div x-show="activeTab === 'siswa'" class="space-y-6">
                    <div class="grid md:grid-cols-2 gap-8">
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-blue-800 mb-4">Pengelolaan Data Siswa</h3>
                            <ol class="space-y-4">
                                <li class="flex gap-3">
                                    <div class="bg-blue-100 text-blue-600 w-8 h-8 rounded-full flex items-center justify-center font-bold shrink-0">1</div>
                                    <div>
                        ...
                        <div class="bg-white rounded-xl p-6 shadow-md">
                            <h3 class="text-xl font-semibold text-blue-800 mb-4">Fitur Data Siswa</h3>
                            <ul class="space-y-4">
                                <li class="flex items-start gap-3">
                                    <i class="bx bx-check-circle text-blue-600 text-xl mt-1"></i>
            ...
            <div class="mt-12 bg-blue-50 rounded-xl p-6">
                <h3 class="text-xl font-semibold text-blue-800 mb-4 text-center">Butuh Bantuan?</h3>
                <div class="grid md:grid-cols-3 gap-6">
                    <div class="text-center">
                        <div class="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
                            <i class="bx bx-help-circle text-3xl text-blue-600"></i>
                        </div>
                    ...
                    <div class="text-center">
                    <div class="bg-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 shadow-md">
                            <i class="bx bx-phone-call text-3xl text-blue-600"></i>
                        </div>
                        <h4 class="font-medium text-blue-800 mb-2">Kontak Langsung</h4>
                    ...
                    <div class="text-center">
                        ...
                        <h4 class="font-medium text-blue-800 mb-2">Video Tutorial</h4>
            ...
            <!-- FAQ Section -->
            <div class="mt-12">
                <h3 class="text-xl font-semibold text-blue-800 mb-6 text-center">Pertanyaan Umum</h3>
                <div class="space-y-4">
                    @php
                    $faqs = [
                        [
                    ...
                    <div x-data="{ open: false }" class="bg-white rounded-xl shadow-md">
                        ...
                        >
                            <span class="font-medium text-blue-800">{{ $faq['question'] }}</span>
            ...
            <div class="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="#" class="flex items-center gap-2 px-4 py-3 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                    <i class="bx bx-book-open text-blue-600"></i>
                    <span class="text-sm text-gray-600">Manual Pengguna</span>
                </a>
                <a href="#" class="flex items-center gap-2 px-4 py-3 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                    <i class="bx bx-video-plus text-blue-600"></i>
