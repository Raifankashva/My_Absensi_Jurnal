    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('attendance.process') }}" method="POST" id="attendanceForm" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="foto" id="foto">
                    <div class="d-grid">
                        <button type="button" class="btn btn-primary" id="capture">Ambil Foto</button>
                        <button type="submit" class="btn btn-success mt-2" id="submit" style="display: none;">Proses Absensi</button>
                    </div>
                </form>
            </div>
        </div>
